...
internal static class FileUtilities
{
    ...
    {
        using StreamReader reader = new(file.OpenRead(), Encoding.Unicode);
    ...
    {
        using FileStream stream = new(Path.GetFullPath(file.FullName), FileMode.Create, FileAccess.Write, FileShare.Read, 4096, FileOptions.SequentialScan | FileOptions.Asynchronous);
